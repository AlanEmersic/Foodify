    ...
    <div className="m-5 flex h-[400px] transform cursor-pointer flex-col justify-between rounded-lg border border-gray-200 bg-white p-5 shadow-md transition duration-500 hover:scale-110">
      ...
      <div className="flex flex-1 flex-col justify-between pt-5">
        ...
        <div className="mt-3 flex items-end justify-between">
          <div
            className="flex w-20 cursor-pointer flex-row items-center rounded-lg bg-orange-400 px-3 py-2 text-center text-sm font-medium text-white hover:bg-orange-500 focus:outline-none focus:ring-4"
          ...
          <div
            className="flex w-28 cursor-pointer flex-row items-center rounded-lg bg-teal-400 px-3 py-2 text-center text-sm font-medium text-white hover:bg-teal-500 focus:outline-none focus:ring-4"
